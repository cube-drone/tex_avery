...
define(["engine/objects",
        ...
        "sample_universe/sound",
        "sample_universe/inventory", 
        "sample_universe/kitchen"], 
        function( objects, load, history, prompt, room, sound, inventory, kitchen){

objects.set_file( "sample_universe/player" );
var public = {};

var me = {
    init: function(){
        objects.set_root(this);
        var path_to_initial_location = "sample_universe/"+ this.get_state('current_location').name;
